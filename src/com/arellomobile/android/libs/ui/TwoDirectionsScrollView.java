 ...
 * allowing it to be larger than the physical display.  A TwoDirectionsScrollView
 * is a {@link FrameLayout}, meaning you should place one child in it
 * containing the entire contents to scroll; this child may itself be a layout
 * manager with a complex hierarchy of objects.
 * <p/>
 * <p>You should never use a TwoDirectionsScrollView with a {@link android.widget.ListView}, since
 ...
 * list of items to fill up the infinite container supplied by TwoDirectionsScrollView.
 * <p/>
 * <p>The {@link android.widget.TextView} class also
 * takes care of its own scrolling, so does not require a TwoDirectionsScrollView, but
...
public class TwoDirectionsScrollView extends FrameLayout {
	...
	/**
	 * Indicates whether this TwoDirectionsScrollView's content is stretched to fill the viewport.
	 *
	...
	/**
	 * Indicates this TwoDirectionsScrollView whether it should stretch its content height to fill
	 * the viewport or not.
	 *
	 ...
	 * component is a good candidate for focus, this TwoDirectionsScrollView reclaims the
	 * focus.</p>
	 *
