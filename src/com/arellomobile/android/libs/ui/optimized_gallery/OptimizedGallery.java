...
public class OptimizedGallery extends CustomAbsSpinner implements GestureDetector.OnGestureListener {

    protected static final String TAG = "Gallery";
    ...
    public OptimizedGallery(Context context, AttributeSet attrs) {
        this(context, attrs, -1);
    }

    public OptimizedGallery(Context context, AttributeSet attrs, int defStyle) {
...
// TODO remove comments and add file attrs.xml to values folder.
// Fill this file like in comments bellow this class

//        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.OptimizedGallery, defStyle, 0);

//        int index = a.getInt(R.styleable.OptimizedGallery_gravity, -1);
        int index = -1;
        if (index >= 0) {
            setGravity(index);
        }

//        int animationDuration = a.getInt(R.styleable.OptimizedGallery_animationDuration, -1);
        int animationDuration = -1;
        if (animationDuration > 0) {
            setAnimationDuration(animationDuration);
        }

//        int spacing = a.getDimensionPixelOffset(R.styleable.OptimizedGallery_spacing, 0);
        int spacing = 0;
        setSpacing(spacing);

//        float unselectedAlpha = a.getFloat(R.styleable.OptimizedGallery_unselectedAlpha, 0.5f);
...
//        a.recycle();
    ...
    protected ViewGroup.LayoutParams generateDefaultLayoutParams() {
        /*
        * Gallery expects OptimizedGallery.LayoutParams.
        */
     ...
     */
    protected View makeAndAddView(int position, int offset, int x,
                                boolean fromLeft) {
     ...
     *                 building from left to right)?
     */
    protected void setUpChild(View child, int offset, int x, boolean fromLeft) {
...
<resources>
    <declare-styleable name="OptimizedGallery">
