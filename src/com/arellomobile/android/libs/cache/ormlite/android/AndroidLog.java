 ...
 * @author graywatson
 */
public class AndroidLog implements com.arellomobile.android.libs.cache.ormlite.logger.Log {
	...
	private int levelToJavaLevel(com.arellomobile.android.libs.cache.ormlite.logger.Log.Level level) {
		switch (level) {
			case TRACE :
				return Log.VERBOSE;
			case DEBUG :
