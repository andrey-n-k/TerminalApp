...
/**
 * Class which implements our {@link com.arellomobile.android.libs.cache.ormlite.logger.Log} interface by delegating to Apache Log4j via
...
public class Log4jLog implements Log {
	...
	private Object levelToJavaLevel(com.arellomobile.android.libs.cache.ormlite.logger.Log.Level level) {
		switch (level) {
			case TRACE :
				return traceLevel;
			case DEBUG :
