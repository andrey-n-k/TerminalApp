 ...
 * </p>
 *
 * Implementation fo interface {@link  com.arellomobile.android.libs.network.INetwork}.<br/>
 * Should call {@link  com.arellomobile.android.libs.network.Network#getInputForRequest(String, java.util.Map, int, java.util.Date, java.lang.String, java.lang.String)} or {@link  com.arellomobile.android.libs.network.Network#openConnection(String, java.util.Map, int, java.util.Date, java.lang.String, java.lang.String)} with {@link Network#close()} in one synchronized block.<br/>
 * Sample. <br/>
 * <code>
...
class Network implements INetwork {
	 ...
	 * @throws NetworkException if response code not valid
	...
	private boolean workWithResponseCode() throws IOException, NetworkException {
		...
		log.severe(LogUtils.getErrorReport(message, networkException));
